...
function makeTrace(overrides: Partial<SessionTrace> & { session_id: string }): SessionTrace {
  return {
...
describe('sortTraces', () => {
  ...
  describe('sort by outcome', () => {
    it('ascending — alphabetical', () => {
      ...
      expect(resultIds.indexOf('trace-b')).toBeLessThan(resultIds.indexOf('trace-c'));
