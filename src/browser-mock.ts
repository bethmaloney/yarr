...
if (!(window as any).__TAURI_INTERNALS__) {
  ...
  const SAMPLE_EVENTS: Record<string, unknown[]> = {
    "sess-abc-123": [
      ...
      { kind: "assistant_text", iteration: 1, text: "Analyzing the login module to understand the bug...", _ts: 1741336205000 },
      { kind: "tool_use", iteration: 1, tool_name: "Read", _ts: 1741336210000 },
      { kind: "tool_use", iteration: 1, tool_name: "Grep", _ts: 1741336215000 },
      { kind: "assistant_text", iteration: 1, text: "Found the issue - session token validation is missing a null check", _ts: 1741336220000 },
      ...
      { kind: "assistant_text", iteration: 2, text: "Now adding unit tests for the login flow...", _ts: 1741336235000 },
      { kind: "tool_use", iteration: 2, tool_name: "Write", _ts: 1741336240000 },
      ...
      { kind: "iteration_complete", iteration: 2, result: { total_cost_usd: 0.1612 }, _ts: 1741336260000 },
      { kind: "iteration_started", iteration: 3, _ts: 1741336261000 },
      { kind: "assistant_text", iteration: 3, text: "Running full test suite to verify no regressions...", _ts: 1741336265000 },
      ...
      { kind: "iteration_complete", iteration: 3, result: { total_cost_usd: 0.1386 }, _ts: 1741336280000 },
      { kind: "session_complete", outcome: "completed", _ts: 1741336335000 },
    ],
    "sess-def-456": [
      { kind: "session_started", session_id: "sess-def-456", _ts: 1741268400000 },
      { kind: "iteration_started", iteration: 1, _ts: 1741268401000 },
      { kind: "assistant_text", iteration: 1, text: "Reading the auth module to plan the JWT refactor...", _ts: 1741268405000 },
      { kind: "tool_use", iteration: 1, tool_name: "Read", _ts: 1741268410000 },
      { kind: "tool_use", iteration: 1, tool_name: "Read", _ts: 1741268415000 },
      { kind: "iteration_complete", iteration: 1, result: { total_cost_usd: 0.1200 }, _ts: 1741268430000 },
      { kind: "iteration_started", iteration: 2, _ts: 1741268431000 },
      { kind: "assistant_text", iteration: 2, text: "Replacing session-based auth with JWT tokens...", _ts: 1741268435000 },
      { kind: "tool_use", iteration: 2, tool_name: "Edit", _ts: 1741268440000 },
      { kind: "tool_use", iteration: 2, tool_name: "Edit", _ts: 1741268450000 },
      { kind: "iteration_complete", iteration: 2, result: { total_cost_usd: 0.1800 }, _ts: 1741268460000 },
      ...
      { kind: "iteration_complete", iteration: 3, result: { total_cost_usd: 0.2000 }, _ts: 1741268480000 },
      ...
      { kind: "iteration_complete", iteration: 4, result: { total_cost_usd: 0.1950 }, _ts: 1741268520000 },
    ...
    "sess-ghi-789": [
      { kind: "session_started", session_id: "sess-ghi-789", _ts: 1741168800000 },
      { kind: "iteration_started", iteration: 1, _ts: 1741168801000 },
      { kind: "assistant_text", iteration: 1, text: "Reading the API routes to understand the list endpoints...", _ts: 1741168805000 },
      { kind: "tool_use", iteration: 1, tool_name: "Grep", _ts: 1741168810000 },
      { kind: "iteration_complete", iteration: 1, result: { total_cost_usd: 0.0950 }, _ts: 1741168830000 },
      { kind: "iteration_started", iteration: 2, _ts: 1741168831000 },
      { kind: "assistant_text", iteration: 2, text: "Adding cursor-based pagination to /users endpoint...", _ts: 1741168835000 },
      { kind: "tool_use", iteration: 2, tool_name: "Edit", _ts: 1741168840000 },
      { kind: "iteration_complete", iteration: 2, result: { total_cost_usd: 0.1200 }, _ts: 1741168860000 },
