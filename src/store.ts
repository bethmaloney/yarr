      ...
      try {
        ...
        const result = await invoke<{ oneshot_id: string; session_id: string }>(
          "run_oneshot",
          {
            ...
            effortLevel,
            designEffortLevel,
            envVars: repo.envVars ?? null,
            maxIterations: repo.maxIterations ?? null,
            completionSignal: repo.completionSignal ?? null,
            checks: repo.checks ?? null,
            gitSync: repo.gitSync,
            plansDir: repo.plansDir ?? null,
            movePlansToCompleted: repo.movePlansToCompleted ?? null,
      ...
      try {
        ...
        const { session_id } = await invoke<{ session_id: string }>(
          "run_session",
          {
            ...
            repo: repoPayload,
            planFile,
            model: repo.model ?? null,
            effortLevel: repo.effortLevel ?? null,
            maxIterations: repo.maxIterations ?? null,
            completionSignal: repo.completionSignal ?? null,
            envVars: repo.envVars ?? null,
            checks: repo.checks ?? null,
            gitSync: repo.gitSync,
            createBranch: repo.createBranch ?? null,
            implementationPromptFile: repo.implementationPromptFile || null,
          },
        );
